...
describe("FooManagerController Tests -", () => {
    ...
    beforeEach(inject(($injector) => {
        ...
        $httpMock.when("GET", "/Kash.JSTSUT.Web/api/Foos/0/firstId")
            .respond(200, 123);

        $httpMock.when("GET", "/Kash.JSTSUT.Web/api/Foos/123")
    ...
    it("delete()", () => {
        ...
        $httpMock.expectGET("/Kash.JSTSUT.Web/api/Foos/123/previousId")
            .respond(200, 122);

        $httpMock.expectGET("/Kash.JSTSUT.Web/api/Foos/122")
